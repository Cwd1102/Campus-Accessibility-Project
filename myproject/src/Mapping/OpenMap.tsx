...
interface MapDisplayProps {
  ...
  // NEW: control user marker + auto-follow behavior per page
            ...
            <GeoJSON
              ...
              style={(feature) => {
                ...
                const isSelected =
                  segmentSelectionMode && id && selectedSegmentIds.includes(id);
                const isHighlighted =
                  id != null && highlightedSegmentIds.includes(id);

                return {
                  // priority: green (search) > red (blocked) > blue (normal)
                  color: isHighlighted ? "#ff00eeff" : isSelected ? "#ff0000" : "#0066ff",
                  weight: 5,
                };
              }}
            />
